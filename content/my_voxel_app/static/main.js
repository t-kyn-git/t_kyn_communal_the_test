...
function createBlockSelector() {
    ...
    for (const type in blockTypes) {
        ...
        item.innerHTML = `<input type="radio" name="blocktype" id="type-${type}" value="${type}"><label for="type-${type}"><img src="${blockTypes[type].texture}" class="block-preview"> ${type}</label>`;
